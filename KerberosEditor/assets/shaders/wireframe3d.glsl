...
layout(location = 0) out vec3 g_FragPos_WorldSpace;
layout(location = 1) out vec3 g_Normal_WorldSpace;
...
layout(location = 3) noperspective in vec3 g_EdgeDistance;
...
void main()
{
    ...
    vec4 texSample = texture(u_Texture, g_TexCoord * 1.0);
